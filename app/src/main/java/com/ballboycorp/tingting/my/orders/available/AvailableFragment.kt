...
class AvailableFragment: BaseFragment() {
    ...
    private fun initialize() {
        ...
        shop.add(OrderItemViewModel(Order(shopItem = ShopItem(duration = 60, amount = 1, price = "11,300"))))
        shop.add(OrderItemViewModel(Order(shopItem = ShopItem(duration = 60, amount = 2, price = "15,300"))))
        shop.add(OrderItemViewModel(Order(shopItem = ShopItem(duration = 60, amount = 3, price = "20,300"))))
